...
void questao14(void){
RCC ->AHB1ENR |= (1<<0);
GPIOA->MODER |= (0b01 << 0) | (0b01 << 2) | (0b01 << 4) | (0b01 << 6) |(0b01 << 8) |(0b01 << 10) |(0b01 << 12) |(0b01 << 16) |(0b01 << 18)|(0b01 << 20) |(0b01 << 22);
  
int var=500;
int num[]={0b0111111,0b0000110,0b1011011,0b1001111,0b1100110,0b1101101,0b1111101,0b0000111,0b1111111,0b1100111,0b1110111,0b1111100,0b0111001,0b1011110,0b1111001,0b1110001};
...
void questao15(void){
RCC ->AHB1ENR |= (1<<0);
GPIOA->MODER |= (0b01 << 0) | (0b01 << 2) | (0b01 << 4) | (0b01 << 6) |(0b01 << 8) |(0b01 << 10) |(0b01 << 12) |(0b01 << 16) |(0b01 << 18)|(0b01 << 20) |(0b01 << 22)|(0b01 << 24);
int num[]={0b0111111,0b0000110,0b1011011,0b1001111,0b1100110,0b1101101,0b1111101,0b0000111,0b1111111,0b1100111,0b1110111,0b1111100,0b0111001,0b1011110,0b1111001,0b1110001};
...
void questao18(void){
RCC-> AHB1ENR |= 0b1001; //Ligar o Clock GPIOA e GPIOD
GPIOA -> MODER |= 0b01 << 18; 
GPIOA -> MODER |= 0b01 << 20;
GPIOD -> MODER |= 0b01 << 0; 
